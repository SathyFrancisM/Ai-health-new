      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <input 
            ...
            required
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700/50 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50 dark:bg-slate-900/50 text-black dark:text-white placeholder-slate-500 dark:placeholder-slate-300"
          />
        </div>
        <div className="relative">
