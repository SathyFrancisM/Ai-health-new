      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => { e.preventDefault(); onSubmit(formData); }}>
        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            <div className="relative">
               ...
               <input name="age" type="number" placeholder="Years" onChange={handleChange} className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50" />
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative">
               ...
               <input name="height" type="number" placeholder="cm" onChange={handleChange} className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50" />
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative">
               ...
               <input name="weight" type="number" placeholder="kg" onChange={handleChange} className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            <select name="bloodGroup" onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50">
          ...
          <div className="relative col-span-full">
            ...
            <div className="relative">
               ...
               <input name="allergies" placeholder="Peanuts, Shellfish, Dust..." onChange={handleChange} className="w-full pl-10 pr-4 py-3 rounded-xl border border-red-100 focus:outline-none focus:ring-2 focus:ring-red-400 transition-all bg-red-50/30" />
            </div>
          ...
          <div className="relative">
            ...
            <select name="activityLevel" onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50">
        ...
        <div className="md:col-span-2 space-y-4">
           <div className="relative">
             ...
             <textarea name="existingConditions" placeholder="Diabetes, Hypertension, None..." onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white/50 h-24" />
           </div>
        </div>
